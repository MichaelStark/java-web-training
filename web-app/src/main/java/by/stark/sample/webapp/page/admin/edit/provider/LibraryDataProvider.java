...
public class LibraryDataProvider extends ListDataProvider<Libriary> implements
	...
	public LibraryDataProvider(List<Libriary> list) {
		super(list);
	}

	@Override
	protected List<Libriary> getData() {
		List<Libriary> list = super.getData();
		SortParam<String> param = this.state.getSort();

		if (param != null) {
			Collections.sort(list, new LibriaryComparator(param.getProperty(),
					param.isAscending()));
		}
	...
	static class LibriaryComparator implements Comparator<Libriary>,
			Serializable {
		private static final long serialVersionUID = 1L;
		...
		public LibriaryComparator(String property, boolean ascending) {
			this.property = property;
			this.ascending = ascending;
		}

		@Override
		public int compare(Libriary p1, Libriary p2) {
